...
try {
    ...
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM usuarios WHERE nombre = :nombre");
    ...
    // Insertar usuario
    $stmt = $pdo->prepare("INSERT INTO usuarios (empleado_id, rol_id, nombre, contrasena, estado)
                           VALUES (:empleado_id, :rol_id, :nombre, :contrasena, 1)");
    $stmt->execute([
